...
<body>
     ...
     <div class="header">
          ...
          <a href="Homepage.php"><img id="logo" src="Images/Website/jara.png"></a>
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
               ...
               <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                         <img class="images1" src="../Images/Website/Farmer1.jpeg" height="800px" width="1350px" alt=".x.">
                         <div class="time"></div>
                    </div>
                    <div class="carousel-item active">
                         <img class="images1" src="../Images/Website/Farmer2.jpeg" height="800px" width="1350px" alt="...">
                    </div>
                    <div class="carousel-item">
                         <img class="images1" src="../Images/Website/Farmer4.jpg" height="800px" width="1350px" alt="...">
                    </div>
               </div>
          </div>
     </div>
