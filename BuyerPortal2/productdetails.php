            ...
            while ($rows = mysqli_fetch_array($runa_query)) {
                ...
                <div class='container'>
                    ...
                    <div class='row'>
                        ...
                        <div class='col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12 text-white' style='background-color:#50C878;'>
                            <div class='text-center farmerdetails mt-4 ' style='color:yellow'><b>
                                    <b>
                                        <h2>Farmer Details
                                        </h2>
                                    </b>
                            ...
                            <div class='details mt-1 text-center'>
                                ...
                                <br>
                                <h4 style='color:yellow' class='text-center '>Get In touch with Farmer</h4>
                                <a  class='btn btn-warning border-secondary  chat' style='color:black;padding:2px;'><b> View Farmer Profile <i class='fas fa-id-card-alt pl-1'></i> </b></a>

                                <h4 style='color:yellow' class='text-center ''>Have Some Query ?<br></h4>
